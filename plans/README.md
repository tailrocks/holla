...
| 007 | TermRock extensions (multi-select, metadata cells, progress, log pane) | P2 | L | 003 | DONE — extensions landed at `ccf0646`; consumer current on v0.11.0 `371ff94` |
| 008 | Disk analyzer TUI + validated deletion choke point | P2 | L | 005, 006, 007 | DONE — TermRock v0.11.0 `371ff94`; smoke: 52.43 MB Trash + permanent delete, rescan, ops.log, terminal restore |
...
| 010 | Launcher frecency ranking + query memory | P3 | M | 005 | DONE — TermRock v0.11.0 `371ff94`; fake-cache PTY: query activation persisted, relaunch showed Recent first, second activation produced 2 uses; terminal restored |
