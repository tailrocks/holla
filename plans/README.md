...
| 007 | TermRock extensions (multi-select, metadata cells, progress, log pane) | P2 | L | 003 | DONE — extensions landed at `ccf0646`; consumer pinned to v0.11.0 `ac54f91` |
| 008 | Disk analyzer TUI + validated deletion choke point | P2 | L | 005, 006, 007 | DONE — TermRock v0.11.0 `ac54f91`; smoke: 52.43 MB Trash + permanent delete, rescan, ops.log, terminal restore |
